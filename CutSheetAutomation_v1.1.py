...
for i in range (0, working_sheet.get_highest_row() - 1):
	...
	provision_sheet['A' + str(cutnum[8])].style = cellstyle2
	...
	provision_sheet['A' + str(cutnum[11])].style = cellstyle2
	...
	provision_sheet['A' + str(cutnum[16])].style = cellstyle2
	...
	provision_sheet['A' + str(cutnum[22])].style = cellstyle2
	...
	provision_sheet['D' + str(cutnum[8])].style = cellstyle3
	...
	provision_sheet['D' + str(cutnum[11])].style = cellstyle3
	...
	provision_sheet['D' + str(cutnum[16])].style = cellstyle3
	...
	provision_sheet['D' + str(cutnum[22])].style = cellstyle3
